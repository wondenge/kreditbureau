...
// The scheme protects the "signin" action used to create JWTs.
...
var _ = Service("secured_kreditbureau", func() {
	Description("This service exposes all endpoints to require valid authorization credentials.")
